...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_INSERT, KC_SPACE,KC_SPACE,LT(_LOWER,KC_SPACE),LT(_RAISE,KC_SPACE),KC_SPACE, KC_SPACE, KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT,
    KC_1,KC_2,KC_3,KC_4
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_LSFT, RGB_TOG,    RGB_MOD,    RGB_HUI,    RGB_HUD,    RGB_SAI,    RGB_SAD,    RGB_VAI,    KC_LBRC,   KC_RBRC,  KC_BSLASH, KC_RSFT,
KC_LCTL, KC_LALT, KC_LGUI, KC_INSERT, KC_SPACE,KC_SPACE,LT(_LOWER,KC_SPACE),LT(_RAISE,KC_SPACE),KC_SPACE, KC_SPACE, KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT,
  KC_1,KC_2,KC_3,KC_4
  ) 
};
